...
const { scanBarcode, getFefoRecommendation, getUomConversions, getValuationDetailed, exportEtaEInvoicePayload } = require('../../controllers/inventoryExtensionsController');
router.use(protect);

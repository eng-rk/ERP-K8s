...
const offerSchema = new mongoose.Schema({
  ...
  description: { type: String, required: [true, 'Offer description is required'] },
  offerType: { type: String, enum: ['Service', 'Product'], default: 'Service' },
  catalogProduct: { type: mongoose.Schema.Types.ObjectId, ref: 'Product', default: null },
  price: { type: Number, required: [true, 'Price is required'] },
  validUntil: { type: Date, required: [true, 'Valid until date is required'] },
  status: { type: String, enum: ['Draft', 'Sent', 'Viewed', 'Accepted', 'Rejected', 'Expired', 'Completed', 'Canceled', 'Refunded', 'Paid'], default: 'Draft' },
  recordLocator: { type: String, default: null, unique: true, sparse: true },
  sentAt: { type: Date, default: null },
  sentVia: { type: String, enum: ['Email', 'SMS', 'Both', null], default: null },
  ...
  paymentMethod: { type: String, enum: ['Card', 'BankTransfer', 'Fawry', 'PayMob', 'InstaPay', 'Cash', null], default: null },

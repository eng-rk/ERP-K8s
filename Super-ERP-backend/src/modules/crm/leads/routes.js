...
router.route('/').get(checkPermission('crm.leads.view'), getLeads).post(checkPermission('crm.leads.create'), createLead);
router.route('/:id').get(checkPermission('crm.leads.view'), getLeadById).put(checkPermission('crm.leads.edit'), updateLead);

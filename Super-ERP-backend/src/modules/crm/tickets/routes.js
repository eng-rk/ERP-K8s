...
router.route('/').get(checkPermission('tickets.desk.view'), getTickets).post(checkPermission('tickets.desk.create'), createTicket);
router.route('/:id').put(checkPermission('tickets.desk.edit'), updateTicket);
